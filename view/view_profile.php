           ...
           <div class="col c-12">
               <div class="profile">
                ...
                <form class="profile__form" action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="username" class="username" placeholder="Tên đăng nhập" value="<?php echo $username?>">
                    <input type="text" name="address" class="address" placeholder="Địa chỉ" value="<?php echo $address?>">
                    <select class="sx" name="sx" id="">
                        <option value="nam">Nam</option>
                        <option value="nữ">Nữ</option>
                        <option value="">Khác</option>
                    </select>
                    <input type="text" name="phone-number" class="phone__number" placeholder="Số điện thoại" value="<?php echo $phone_number?>">
                    <input type="text" class="birthday" name="birthday" placeholder="Ngày tháng năm sinh" value="<?php echo $birthday?>">
